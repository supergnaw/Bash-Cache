# Special thanks: https://github.com/RoverWire/virtualhost
# to use globally, save to /usr/local/bin/virtualhost
# permission to execute: chmod +x /usr/local/bin/virtualhost
